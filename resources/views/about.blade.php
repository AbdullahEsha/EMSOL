...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('common/assets/images/icons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('common/assets/images/icons/favicon-16x16.png')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                <div class="about-images">
                                    <img src="{{asset('common/assets/images/about/img-1.jpg')}}" alt=""
                                        class="about-img-front">
                                    <img src="{{asset('common/assets/images/about/img-2.jpg')}}" alt=""
                ...
                <div class="container">
                            ...
                            <div class="brands-display">
                                <div class="row justify-content-center">
                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/1.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/2.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/3.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/4.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/5.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/6.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/7.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/8.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{asset('common/assets/images/brands/9.png')}}" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->
                                </div><!-- End .row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{asset('common/assets/images/team/member-1.jpg')}}" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{asset('common/assets/images/team/member-2.jpg')}}" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{asset('common/assets/images/team/member-3.jpg')}}" alt="member photo">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="about.html">About EMS</a></li>
                                    <li><a href="#">How to shop on EMS</a></li>
                                    <li><a href="#">FAQ</a></li>
