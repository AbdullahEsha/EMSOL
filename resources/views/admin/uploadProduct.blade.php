...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{asset('admin/vendors/css/pickers/pickadate/pickadate.css')}}"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{asset('admin/vendors/css/forms/toggle/switchery.min.css')}}"
    />
    <!-- END: Vendor CSS-->
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{asset('admin/css/pages/app-invoice.css')}}"
    />
    <!-- END: Page CSS-->
                  ...
                  <li class="col-md-5 px-2">
                    ...
                    <ul class="row mt-2">
                      <li class="col-6 col-xl-4">
                        <a
                          class="text-center mb-2 mb-xl-3"
                          href="app-email.html"
                          target="_blank"
                      ...
                      <li class="col-6 col-xl-4">
                        <a
                          ...
                          target="_blank"
                          ><i
                            class="feather icon-message-square font-large-1 mr-0"
                          ></i>
                      ...
                      <li class="col-6 col-xl-4">
                        <a
                          ...
                          target="_blank"
                          ><i
                            class="feather icon-check-square font-large-1 mr-0"
                          ></i>
                      ...
                      <li class="col-6 col-xl-4">
                        <a
                          ...
                          target="_blank"
                          ><i
                            class="feather icon-file-plus font-large-1 mr-0"
                          ></i>
                      ...
                      <li class="col-6 col-xl-4">
                        <a
                          ...
                          target="_blank"
                          ><i class="feather icon-users font-large-1 mr-0"></i>
                      ...
                      <li class="col-6 col-xl-4">
                        <a
                          ...
                          target="_blank"
                          ><i
                            class="feather icon-printer font-large-1 mr-0"
                          ></i>
                  ...
                  <li class="scrollable-container media-list">
                    <a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left align-self-center">
                          <i
                            class="feather icon-plus-square icon-bg-circle bg-cyan"
                          ></i>
                        </div>
                    ...
                    ><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left align-self-center">
                          <i
                            class="feather icon-download-cloud icon-bg-circle bg-red bg-darken-1"
                          ></i>
                        </div>
                        <div class="media-body">
                    ...
                    ><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left align-self-center">
                          <i
                            class="feather icon-alert-triangle icon-bg-circle bg-yellow bg-darken-3"
                          ></i>
                        </div>
                        <div class="media-body">
                    ...
                    ><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left align-self-center">
                          <i
                            class="feather icon-check-circle icon-bg-circle bg-cyan"
                          ></i>
                        </div>
                        <div class="media-body">
                    ...
                    ><a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left align-self-center">
                          <i
                            class="feather icon-file icon-bg-circle bg-teal"
                          ></i>
                        </div>
                        <div class="media-body">
                ...
                >
                  <li class="dropdown-menu-header">
                    <h6 class="dropdown-header m-0">
                      ...
                      ><span
                        class="notification-tag badge badge-warning float-right m-0"
                        >4 New</span
                      >
                    </h6>
                  </li>
                    ...
                    <a href="javascript:void(0)">
                      <div class="media">
                        <div class="media-left">
                          <div
                            class="avatar avatar-online avatar-sm rounded-circle"
                          >
                            <img
        ...
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
            ...
            >
              ...
              <a class="btn btn-outline-primary" href="full-calender-basic.html"
                ><i class="feather icon-mail"></i></a
              ><a class="btn btn-outline-primary" href="timeline-center.html"
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card-header">
                      <div class="row">
                        <div
                          class="col-xl-3 col-md-12 d-flex justify-content-start align-items-center pl-0"
                        >
                          <h6 class="invoice-text mr-1 font-weight-bold">
                            Invoice#
                          </h6>
                          <input
                            type="text"
                        ...
                        <div
                          class="col-xl-9 col-md-12 d-flex justify-content-xl-end align-items-lg-start align-items-sm-start align-items-xs-start align-items-center flex-wrap px-0 pt-xl-0 pt-1"
                        >
                          <div
                          ...
                          <div
                            class="due-date d-flex align-items-center justify-content-start"
                          >
                            <h6 class="invoice-text mr-1 font-weight-bold">
                              Date Due
                            </h6>
                    ...
                    <div class="row my-2">
                      ...
                      <div
                        class="col-sm-6 col-12 order-1 order-sm-1 d-flex justify-content-end align-items-center"
                      >
                        <img
                          src="{{asset('admin/images/logo/pixinvent-logo.png')}}"
                          alt="logo"
                          height="46"
                          width="164"
                        />
                        ...
                        <div data-repeater-list="group-a">
                          <div data-repeater-item class="mb-1">
                            <div class="row item-heading-titles mb-50">
                              <div
                                class="col-3 col-md-4 item-subtitle font-bold"
                              >
                                Item
                              </div>
                              ...
                              <div class="col-3 qty-subtitle font-bold">
                                Qty
                              </div>
                              <div
                                class="col-3 col-md-2 price-subtitle font-bold"
                              >
                                Price
                              </div>
                            </div>
                            <div class="repeater-controls d-flex">
                              ...
                              >
                                <div class="row invoice-item-controls d-flex">
                                  ...
                                  <div
                                    class="col-12 col-md-3 form-group item-quantity"
                                  >
                                    <input
                                      type="text"
                                      class="form-control"
                                  ...
                                  <div
                                    class="col-12 col-md-4 form-group item-description mb-0"
                                  >
                                    <input
                                      type="text"
                                  ...
                                  <div
                                    class="col-12 col-md-8 form-group discounts mb-0"
                                  >
                                    ...
                                    >
                                      <div class="row invoice-taxes-controls">
                                        ...
                                        <div class="col-6">
                                          ...
                                          <select
                                            name="tax-val-1"
                                            class="form-control stopPropgate"
                                            id="applicable-tax1"
                                          >
                ...
                <div class="action-buttons card">
                  <div class="card-body">
                    <button class="btn btn-block btn-primary mb-1">
                      <i class="fa fa-share common-size"></i> Send Invoice
                    </button>
                    <button class="btn btn-block btn-primary mb-1">
                      Download Invoice
                    </button>
                    <div
                      class="inline-btns w-100 d-flex justify-content-between"
                    >
                      <div class="btn-save w-50 mr-50">
                        <button class="btn btn-light mb-1 btn-block">
                          Preview
                        </button>
                      </div>
                    ...
                    <button class="btn btn-block btn-success">
                      <i class="fa fa-usd common-size"></i> Payment
                    </button>
                  </div>
                </div>
                <div class="payment-options border rounded m-0 py-2 row">
                  ...
                  <div class="col-12 mt-75">
                    <select
                      name="payment"
                      id="paymentOption"
                      class="form-control bg-transparent mb-1"
                    >
                  ...
                  <div class="col-12 mt-1">
                    <div class="form-group mb-25">
                      ...
                      <label for="switchery0" class="font-medium-2"
                        >Payment Terms</label
                      >
                    </div>
                  </div>
