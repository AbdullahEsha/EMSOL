                ...
                <li class="scrollable-container media-list">
                  <a href="javascript:void(0)">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle"><img
                            src="{{asset('admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar" /><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <div class="avatar avatar-online avatar-sm rounded-circle">
                          <img src="{{asset('admin/images/portrait/small/avatar-s-3.png')}}" alt="avatar" /><i></i>
                        </div>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle"><img
                            src="{{asset('admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar" /><i></i></span>
                      </div>
                      <div class="media-body">
